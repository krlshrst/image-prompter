...
export const AI_SYSTEMS: AISystem[] = ["Midjourney", "Flux", "Nano Banana Pro"];
...
export const LIGHTING_OPTIONS = [
  ...
  "Dramatisches Chiaroscuro", "Neon / Rim Light", "Gegenlicht (Backlighting)",
...
export const SYSTEM_PROMPT = `Du bist ein Experte für KI-Bildgenerierungs-Prompts. Analysiere das gegebene Bild und/oder die Beschreibung und generiere hochoptimierte, strukturierte Prompts für die angeforderten KI-Systeme.

Jeder Prompt muss als strukturiertes Parameter-Objekt zurückgegeben werden – NICHT als einzelner String.

MIDJOURNEY (V7) – Natural Language First
Schreibe vollständige, beschreibende Sätze – KEINE Keyword-Listen.
Formel: [Subjekt] + [Medium / Stil] + [Komposition / Kamera] + [Licht] + [Atmosphäre] + [--Parameter]
...
{ "Midjourney": { ... }, "Flux": { ... }, "Nano Banana Pro": { ... } }
...
export const EMPTY_FORM_STATE: PromptFormState = {
  ...
  mj_version: "7", mj_quality: "1", mj_stylize: "", mj_chaos: "", mj_weird: "", mj_seed: "", mj_style_raw: true,
  flux_style_preset: "",
